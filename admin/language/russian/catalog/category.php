...
$_['entry_description']      = 'Описание:<br /><br /><span class="help">
Город = {city}<br />
Городе = {city_in}<br />
Городу = {city_to}<br />
Города = {city_a}<br /><br />
Сервисы = {service_centers}</span>';
...
$_['entry_info']              = 'Эта категория - статья:<br/><span class="help">Использование категории только для информации.</span>';
$_['entry_manufacturer']             = 'Производитель:';
$_['entry_podarok']          = 'Текст подарка:';
