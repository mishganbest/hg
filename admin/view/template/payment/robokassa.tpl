    ...
    <div class="content">
	  ...
	  <div id="tab-general" style="display: block;">
        <table class="form">
          ...
          <tr>
            ...
            <td><input type="password" autocomplete="off"  name="robokassa_password1" /> <?php if($robokassa_password1) echo $text_saved; ?></td>
          </tr>
		  <tr>
            <td><?php echo $entry_password2; ?></td>
            <td><input type="password"  autocomplete="off"  name="robokassa_password2" /> <?php if($robokassa_password2) echo $text_saved; ?></td>
          </tr>
		  ...
		  <table id="block_premod0" class="form" width=100%>
		  <tr>
	  ...
	  <div id="tab-general-<?php echo $STORE['store_id']; ?>" style="display: none;">
        <table class="form">
		  ...
		  <table id="block_premod<?php echo $STORE['store_id']; ?>" class="form" width=100%>
		  <tr>
            <td><?php echo $entry_order_comment; ?></td>
            <td>
			<?php foreach ($languages as $language) { ?>
