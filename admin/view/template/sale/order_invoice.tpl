...
<div>
  <h1><?php echo $text_order_id; ?>
   <b><?php echo $order['order_id']; ?></b>
  
  </h1>
  <table class="store">
    <tr>
<td><img src="http://healthygoods.ru/image/data/logo_75px.png" height="57" alt="" id="thumb-logo"/></td>    
