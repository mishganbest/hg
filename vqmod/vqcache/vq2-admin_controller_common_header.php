...
$this->data['text_service_center'] = $this->language->get('text_service_center');
			$this->data['text_delivery_point'] = $this->language->get('text_delivery_point');
...
$this->data['service_center'] = $this->url->link('localisation/service_center', 'token=' . $this->session->data['token'], 'SSL'); 
			$this->data['delivery_point'] = $this->url->link('localisation/delivery_point', 'token=' . $this->session->data['token'], 'SSL');
