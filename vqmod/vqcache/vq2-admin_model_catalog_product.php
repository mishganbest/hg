...
return $product_id;
	...
	public function getTotalServiceCentersByCityId($city_id) {
		$query = $this->db->query("SELECT COUNT(*) AS total FROM " . DB_PREFIX . "service_center WHERE city_id = '" . (int)$city_id . "'");
