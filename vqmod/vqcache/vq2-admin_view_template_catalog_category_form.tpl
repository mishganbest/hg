    ...
    <div class="content">
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
		...
		<tr>
                ...
                <td><textarea name="category_description[<?php echo $language['language_id']; ?>][podarok]" cols="100" rows="2"><?php echo isset($category_description[$language['language_id']]) ? $category_description[$language['language_id']]['podarok'] : ''; ?></textarea></td>
              </tr>
            </table>
          </div>
          <?php } ?>
        ...
        <div id="tab-data">
          <table class="form">
            ...
            <tr>
              ...
              <td><?php if ($info) { ?>
                <input type="checkbox" name="info" id="display_manufacturer" value="1" checked="checked" />
                <?php } else { ?>
                <input type="checkbox" name="info" id="display_manufacturer" value="1" />
                <?php } ?></td>
            </tr>
            <tr id="manufacturer" style="display:none">
...
$(document).ready(function(){
	$('#display_manufacturer').change(function() {
