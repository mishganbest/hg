...
<?php } ?>
<link rel="stylesheet" type="text/css" href="catalog/view/theme/default/stylesheet/stylesheet.css?ver=2" />
...
<script type="text/javascript" src="/index.php?route=shipping/sheepla/script"></script>
</head>
<body>
<div id="container">
<div id="header">
...
<div class="slogan">
    <h1>Мойки, очистители и <br />увлажнители воздуха</h1>
    <div><span class="delivery_day_head">Доставка по <?php echo $city_to; ?><br /> <?php echo $delivery_period_to_door; ?></span><span class="cursiv"><a href="<?php echo $contact; ?>"><?php echo $text_contact; ?></a><a href="<?php echo $delivery; ?>"><?php echo $text_delivery; ?></a></span></div>
</div>
<?php } else { ?>
<?php $name = iconv_strlen($title, 'UTF-8'); ?>
<?php if ($name > 55) { ?>
<div class="slogan-noindex3">
<?php } elseif ($name > 35) { ?>
<div class="slogan-noindex2">
<?php } else { ?>
<div class="slogan-noindex">
<?php } ?>
...
<div class="callmeback_content"><?php echo $module; ?></div>
  ...
  <div id="cart">    
    <img src="catalog/view/theme/default/image/cart.png"/><span><a href="javascript:void(0);"><?php echo $text_cart; ?></a></span><a><span id="cart_total" class="bold"><?php echo $text_items; ?></span></a>
