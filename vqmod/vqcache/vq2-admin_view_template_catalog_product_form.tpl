  ...
  <div class="box">
    ...
    <div class="content">
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
		...
		<tr>
                <td><?php echo $entry_podarok; ?></td>
                <td><textarea name="product_description[<?php echo $language['language_id']; ?>][podarok]" cols="100" rows="2"><?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['podarok'] : ''; ?></textarea></td>
              </tr>
            </table>
          </div>
          <?php } ?>
        ...
        <div id="tab-discount">
          <table id="discount" class="list">
			...
			<td class="right"><input type="text" name="product_discount[<?php echo $discount_row; ?>][percentage]" value="<?php echo((1 - $product_discount['price'] * (1/$price)) * 100); ?>" size="3" onkeyup="calcPrice('discount', <?php echo $discount_row; ?>)" /></td>
        ...
        <div id="tab-special">
          <table id="special" class="list">
			...
			<td class="right"><input type="text" name="product_special[<?php echo $special_row; ?>][percentage]" value="<?php echo((1 - $product_special['price'] * (1/$price)) * 100); ?>" size="3" onkeyup="calcPrice('special', <?php echo $special_row; ?>)"/></td>
...
function addDiscount() {
    ...
    html += '    <td class="right"><input type="text" name="product_discount[' + discount_row + '][priority]" value="" size="2" /></td>';
			...
			html += '<td class="right"><input type="text" name="product_discount[' + discount_row + '][percentage]" value="" size="3" onkeyup="calcPrice(\'discount\',' + discount_row +')"/></td>';
...
function addSpecial() {
    ...
    html += '    <td class="right"><input type="text" name="product_special[' + special_row + '][priority]" value="" size="2" /></td>';
			...
			html += '    <td class="right"><input type="text" name="product_special[' + special_row + '][percentage]" value="" size="3" onkeyup="calcPrice(\'special\',' + special_row +')"/></td>';
