...
class ControllerCheckoutSimpleCheckout extends Controller { 
    public function index($args = null) {
        ...
        if ($this->cart->hasProducts() || !empty($this->session->data['vouchers'])) {
            ...
            $this->data['text_agreement'] = sprintf($this->language->get($langId), $this->url->link('information/information/info', 'information_id=' . $this->simplecheckout->getSettingValue('agreementId'), 'SSL'), $title, $title);
