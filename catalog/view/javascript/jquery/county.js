(function ($) {
    $.fn.county = function (options) {
        ...
        return this.each(function () {
            ...
            container.append('<span class="county-days-wrapper"><span class="county-days">00</span></span><span class="county-hours-wrapper"><span class="county-hours">00</span></span><span class="county-minutes-wrapper"><span class="county-minutes">00</span></span><span class="county-seconds-wrapper"><span class="county-seconds">00</span></span>');
            if (container.attr('id') == undefined || container.attr('id') == null) {
                container.attr('id', Math.random());
            }
           

            container.css({ width: 330 });
