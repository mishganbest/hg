...
class ModelAccountCustomer extends Model {
	...
	public function getCustomerNextId() {
		$query = $this->db->query("SELECT MAX(customer_id) + 1 AS max FROM customer");
