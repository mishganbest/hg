...
$_['text_checkout_shipping_address'] = 'Информация для оплаты и доставки заказа';
$_['text_checkout_shipping_method']  = 'Доставка курьером / Самовывоз';
...
$_['text_agree']                     = 'Я прочитал(-a) <a class="fancybox" href="%s" alt="%s"><b>%s</b></a> и согласен(-a) с условиями';
...
$_['text_shipping_detailed']         = 'Если Вы хотите дополнительно согласовать какие-то моменты, напишите об этом в комментариях - мы Вам перезвоним и ответим на все вопросы.';
// Column
