...
$_['text_shipping_address']          = 'Введите Ваш город для получения информации по доставке';
...
$_['error_no_shipping']              = 'Большой объем груза.<br /> Для расчета стоимости доставки обратитесь по телефону.';
